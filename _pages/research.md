...
We focus on various areas targeted towards improving the security of embedded systems, such as Vulnerability Detection and prevention, Developer tools
to engineer secure systems.

**Security of Continuous Integration Workflows.**
...
We focus on defining the desired security properties of a workflow and developing platform-independent techniques to verify and enforce the security properties.

**Vulnerability Detection.**
We work on developing novel vulnerability detection techniques for software across the entire stack --- applications, libraries, OS kernel, and drivers.
